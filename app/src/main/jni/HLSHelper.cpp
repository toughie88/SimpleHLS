// Bridge between Superpowered and Android
// Much derived from Superpowered examples
...
extern "C" {
JNIEXPORT void Java_com_mullis_clay_simplehlsstream_MainActivity_SetTempFolder(JNIEnv *javaEnvironment, jobject self, jstring path);
JNIEXPORT void Java_com_mullis_clay_simplehlsstream_MainActivity_StartAudio(JNIEnv *javaEnvironment, jobject self, jlong samplerate, jlong buffersize);
JNIEXPORT void Java_com_mullis_clay_simplehlsstream_MainActivity_onForeground(JNIEnv *javaEnvironment, jobject self);
